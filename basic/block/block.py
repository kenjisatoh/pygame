...
from pygame.locals import KEYDOWN, K_ESCAPE, K_LEFT, \
    K_RIGHT, K_SPACE, K_UP, QUIT, RLEACCEL, Rect
...
class PyAction:
    def __init__(self):
        ...
        # 画像のロード
        # 左向き
        Python.left_image = load_image("python.png", -1)
        # 右向き
        Python.right_image = pygame.transform.flip(Python.left_image, 1, 0)
